              ...
              <div className="px-16">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex gap-x-2 mt-2">
                    <button className="border border-gray-400 px-4 py-2 rounded-lg">S</button>
                    <button className="border border-gray-400 px-4 py-2 rounded-lg">M</button>
                    <button className="border border-gray-400 px-4 py-2 rounded-lg">L</button>
                    <button className="border border-gray-400 px-4 py-2 rounded-lg">XL</button>
                  </div>
                </div>
                ...
                <div className="mt-10 flex gap-x-6 justify-between">
                  <div className="max-w-xs">
                    <div className="relative flex items-center max-w-[8rem]">
                      ...
                      <button type="button" id="increment-button" data-input-counter-increment="quantity-input" className="bg-white dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 border-l-0 rounded-e-lg p-3 h-11 focus:ring-transparent dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
