        ...
        <form className={openSearch ? 'max-w-xl mx-auto overflow-hidden  h-12 transition-all duration-200 fixed mt-6 left-32 right-32 -top-2 z-40' : 'max-w-xl mx-auto overflow-hidden h-0 transition-all duration-200 fixed mt-6 left-32 right-32 -top-2 z-40'} >
          <div className="flex">
            <div className="relative w-full">
              <input type="search" id="search-dropdown" className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-md order-s-gray-50 border border-gray-300 focus:ring-gray-300 focus:border-gray-300 outline-none" placeholder="Search Mockups, Logos, Design Templates..." required />
